<?php
$default_email['subject'] = 'Invoice for Posting of __POST_TITLE__';
$default_email['text'] = 'Thank you for using __SITE_TITLE__!
...
$default_email['html'] = '
<p style="text-align: center;"><img src="__ORGANIZATION_LOGO__" alt="__ORGANIZATION_NAME__"></p>
