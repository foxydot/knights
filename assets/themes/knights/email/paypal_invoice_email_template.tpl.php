...
<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
    <tr>
        ...
        <table cellpadding="0" cellspacing="0" border="0" align="center">
            <tr>
                <td width="600" valign="top" align="center"><img class="image_fix" src="full path to image" alt="Your alt text" title="Your title text" width="x" height="x" /></td>
                <td width="600" valign="top">'.$message_plaintext.'</td>
