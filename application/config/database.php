...
$db['development']['username'] = 'ro_knights';
$db['development']['password'] = 'ro_knights';
$db['development']['database'] = 'ro_knights';
...
$db['production']['username'] = 'msdlabth_knights';
$db['production']['password'] = 'm&g$TG@;$yr)';
$db['production']['database'] = 'msdlabth_knights';
